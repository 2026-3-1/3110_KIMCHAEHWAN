        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 h-16 flex items-center gap-5">
          ...
          <nav className="flex items-center gap-1 text-sm shrink-0">
            ...
            <div className="flex items-center gap-2.5 ml-2 pl-3 border-l border-gray-100">
              ...
              <Link
                to="/settings"
                className="ml-1 text-xs text-gray-400 hover:text-indigo-600 hover:bg-indigo-50 px-2 py-1 rounded-lg transition-all"
                title="설정"
              >
                ⚙️
              </Link>
              <button
                ...
                className="text-xs text-gray-400 hover:text-red-500 hover:bg-red-50 px-2 py-1 rounded-lg transition-all"
              >
                로그아웃
              </button>
            </div>
